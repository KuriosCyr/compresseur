...
// 			formData.append('type',uploadForm["type"]);
            formData.append('type', uploadForm.querySelector('input[name="type"]:checked').value);
	...
	function appendImages(responseText, status) {
		...
		// Ajoutez un lien de téléchargement pour l'archive zip
    if (response.downloadUrl) {
        const downloadLink = document.createElement('a');
        downloadLink.href = response.downloadUrl;
        downloadLink.innerText = 'Télécharger les images zippées';
